export const gameHtml = `<div class="stars" id="stars"></div>
    <div class="game-wrapper" id="gameWrapper">
                ...
                <div class="gema-poder-icon" id="gemaPodeIcon" style="display:none;" onclick="event.stopPropagation(); toggleFinalesMenu();">
                    ...
                    <div class="finales-menu" id="finalesMenu">
                        <div class="finales-menu-slots">
                            <div class="finales-medal-slot" id="medalSlot0" title="Próximamente">
                                <span class="medal-placeholder">🔒</span>
                            </div>
                            <div class="finales-medal-slot" id="medalSlot1" title="Próximamente">
                                <span class="medal-placeholder">🔒</span>
                            </div>
                            <div class="finales-medal-slot" id="medalSlot2" title="Próximamente">
                                <span class="medal-placeholder">🔒</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="panel">
            <div class="gems-balance">
                <div class="label">🪙 Tus Monedas</div>
                <div class="value-row">
                    ...
                    <div style="position: relative;">
                        ...
                        <div class="god-crown" id="godCrown" style="display:none;" onclick="useGodCrown()" title="¡Duplica tus gemas!"></div>
            ...
            <div class="upgrade-section collapsed">
                <div class="upgrade-header" id="upgradeHeader" onclick="toggleUpgrades()"><span class="upgrade-title">⬆️  Mejoras  📈</span><span class="upgrade-caret" id="upgradeCaret">^</span></div>
                <div class="upgrade-item" id="upgradeAlmacenRow">
                    <div class="info">
                        <div id="almacenInfoTitle" style="font-weight:700; color:#e2e8f0;">📦 Almacén: Nivel 1</div>
                        <div id="almacenInfoDesc" style="font-size:0.65rem; color:#94a3b8;">Porcentaje venta 66%</div>
                    </div>
                    <button id="upgradeAlmacenBtn" onclick="upgradeAlmacen()">150💰</button>
                </div>
                <div class="upgrade-item">
                    <div class="info">
                        <div id="luckInfoTitle" style="font-weight:700; color:#e2e8f0;">🍀 Suerte nivel: 1</div>
                        <div id="luckInfoDesc" style="font-size:0.65rem; color:#94a3b8;">Gemas y fusión</div>
                    </div>
                    <button id="upgradeLuckBtn" onclick="upgradeLuck()">500💰</button>
                </div>
            </div>
        </div>
        <div class="game-container">
            <div class="ticket-container" id="ticketContainer">
                <div class="scratch-card" id="scratchCard">
                    <div class="empty-ticket-message">🎫 Compra un ticket para jugar</div>
                </div>
            </div>
            ...
            <div class="game-buttons">
                <button class="btn-primary" id="newGameBtn">🪙 Raspar (100🪙)</button>
                <button class="btn-favor" id="favorBtn" onclick="activateFavor()">🤝 Favor</button>
            </div>
            <p class="favor-info" id="favorInfo" style="display:none;">Recibes 150🪙 GRATIS pero debes devolver el favor...</p>
            <div class="circle-btns">
                <div class="raspar-circle-wrapper">
                    <button class="circle-btn btn-raspar-circle" id="rasparCircleBtn" onclick="newGame()">🪙</button>
                    <div class="circle-btn-label">Raspar</div>
                </div>
                <div>
                    <button class="circle-btn btn-almacen" id="btnAlmacen" onclick="openAlmacen()">📦</button>
                    <div class="circle-btn-label">Almacén</div>
                </div>
                <div>
                    <button class="circle-btn btn-fusion" id="btnFusion" onclick="openFusion()">⚗️</button>
                    <div class="circle-btn-label">Forja</div>
                </div>
                <div class="compressor-wrapper">
                    <button class="circle-btn btn-compressor" id="btnCompressor" onclick="openCompressor()">🗜</button>
                    <div class="circle-btn-label">Compresora</div>
                </div>
                <div>
                    <button class="circle-btn btn-polish" id="btnPolish" onclick="openPolish()">✨</button>
                ...
                <div class="pronto-wrapper">
                    <div class="pronto-popup" id="prontoPopup" onclick="event.stopPropagation()">
                        ...
                        <div class="pronto-popup-remove" id="prontoRemoveBtn" onclick="removeProntoGem()" style="display:none;">✕ Quitar</div>
                    </div>
                    <div class="btn-coming-soon" id="btnComingSoon" title="Próximamente">?</div>
    ...
    <div class="proximamente-overlay" id="proximamenteOverlay" onclick="closeProximamente()">
        <div class="proximamente-box" id="proximamenteBox" onclick="event.stopPropagation()">
            <div class="proximamente-title">Próximamente</div>
            <div class="proximamente-subtitle">Esta función está en desarrollo...</div>
    ...
    <div class="cryo-warn-overlay" id="cryoWarnOverlay">
        <div class="cryo-warn-hint">
            <div class="cryo-warn-hint-main">❄️ No debería congelarme sin poder revertirlo...</div>
            <div class="cryo-warn-hint-sub">Esta acción no se puede deshacer.</div>
        </div>
        <div class="cryo-warn-btns">
            <button class="cryo-warn-btn-back" onclick="closeCryoWarning()">✕ Volver</button>
    ...
    <div class="cryo-warn-overlay" id="portalWarnOverlay">
        <div class="cryo-warn-hint">
            <div class="cryo-warn-hint-main">🌀 ¿Viajar al mundo principal?</div>
            <div class="cryo-warn-hint-sub">El portal te llevará de vuelta al inicio.</div>
        </div>
        <div class="cryo-warn-btns">
            <button class="cryo-warn-btn-back" onclick="closePortalWarning()">✕ Cancelar</button>
    ...
    <div class="win-message-overlay" id="winMessageOverlay">
        <div class="win-message" id="winMessage">
            <div>
                <div class="new-badge" id="newBadge" style="display:none;">✨ ¡NUEVA!</div>
                <h2 id="winTitle">¡FELICITACIONES!</h2>
                <div class="prize-display" id="winPrizeDisplay">🪙</div>
                <p class="prize-info" id="winPrizeText">Diamante - Legendario</p>
                <p class="prize-value" id="winPrizeValue">+500 🪙</p>
            </div>
    ...
    <div class="modal-overlay" id="expandModal">
        <div class="modal-content expand-modal">
            <div class="modal-header">
                ...
                <p>Máximo actual: <span id="currentMaxDisplay">10,000</span> 🪙</p>
            </div>
    ...
    <div class="modal-overlay" id="almacenModal">
        <div class="modal-content">
            ...
            <div class="tabs">
                <button class="tab active" onclick="showAlmacenTab('base')">💎 Base</button>
                <button class="tab" onclick="showAlmacenTab('created')">🎲 Creadas</button>
                <button class="tab" onclick="showAlmacenTab('polished')">✨ Pulidas</button>
    ...
    <div class="modal-overlay" id="fusionModal">
        <div class="modal-content">
            ...
            <div class="fusion-area">
                ...
                <button class="fusion-btn" id="fusionBtn" onclick="executeFusion()" disabled>⚗️ Fusionar</button>
                <div class="gem-select-title">Elige gema (necesitas ×2):</div>
    ...
    <div class="modal-overlay" id="compressorModal">
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align:center;">
                <p style="color:#9ca3af;font-size:0.7rem;margin-bottom:10px;">Comprime ×50 gemas para crear una Singularidad</p>
                ...
                <button class="fusion-btn" id="compressorBtn" onclick="executeCompression()" disabled>🗜 Comprimir</button>
                <div class="gem-select-title">Elige gema (necesitas ×50):</div>
    ...
    <div class="modal-overlay" id="polishModal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p>Cuesta 500🪙 - Multiplicador variable según tu habilidad</p>
            </div>
            <div class="grid" id="polishGrid"></div>
            <div class="action-panel">
                <p style="color: #a0a0a0; font-size: 0.75rem; margin: 10px 0;"> Puedes pulir gemas por 💰500 resolviendo un minijuego para aumentar su valor</p>
            </div>
        ...
        <div class="modal-content polish-game-content">
            <div class="polish-game-arena" id="polishArena">
                ...
                <div class="polish-hud">
                    <div class="polish-hud-box">⭐ <b id="polishCaught">0</b>/10</div>
                    <div class="polish-hud-box">×<b id="polishMult">1.0</b></div>
                </div>
                <div id="polishHeatWarning" style="position: absolute; top: 50px; left: 0; width: 100%; text-align: center; color: #ff4444; font-size: 0.65rem; font-weight: bold; opacity: 0; transition: opacity 0.3s; z-index: 18; padding: 0 20px;">
                    ⚠️ Mantén la lima centrada para evitar sobrecalentamiento
                </div>
                <!-- Lima -->
        ...
        <div class="modal-content" style="max-width: 320px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px; padding: 10px 0;">
                <div style="background: rgba(0,0,0,0.25); padding: 15px; border-radius: 12px;">
                    <div style="color: #e2e8f0; font-weight: 600; margin-bottom: 8px;">💾 Datos del Juego</div>
                    <p style="color: #94a3b8; font-size: 0.75rem; margin-bottom: 12px;">Tu progreso se guarda automáticamente en este dispositivo.</p>
                </div>
                <div style="background: rgba(0,0,0,0.25); padding: 15px; border-radius: 12px;">
                    <div style="color: #e2e8f0; font-weight: 600; margin-bottom: 8px;">🎮 Opciones de Juego</div>
                    <div style="display: flex; flex-direction: column; gap: 10px;">
                        <label style="display: flex; align-items: center; gap: 10px; color: #94a3b8; font-size: 0.8rem;">
                            ...
                            Cambio de ticket instantáneo
                        </label>
                    </div>
                </div>
                <div style="background: rgba(239,68,68,0.15); padding: 15px; border-radius: 12px; border: 1px solid rgba(239,68,68,0.3);">
                    <div style="color: #fca5a5; font-weight: 600; margin-bottom: 8px;">⚠️ Zona de Peligro</div>
                    <p style="color: #94a3b8; font-size: 0.75rem; margin-bottom: 12px;">Esta acción borrará TODO tu progreso permanentemente.</p>
                    <button onclick="confirmResetGame()" style="width: 100%; padding: 12px; background: linear-gradient(135deg, #ef4444, #dc2626); color: white; border: none; border-radius: 10px; font-weight: 600; cursor: pointer;">🔄 Reiniciar Juego</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="crown-confirm-overlay" id="crownConfirmModal">
        <div class="crown-confirm-box">
            <div class="crown-confirm-icon">👑</div>
            <div class="crown-confirm-title">Utilizar esta corona duplicará tu plata actual.<br><br>¿Quieres utilizar la Corona de Dios?</div>
            <div class="crown-confirm-buttons">
                <button class="crown-btn-cancel" onclick="closeCrownConfirm()">Rechazar</button>
                <button class="crown-btn-use" onclick="confirmUseGodCrown()">✨ Usar</button>
            </div>
        </div>
    </div>
    ...
    <div class="amulet-info-overlay" id="amuletInfoModal">
        <div class="amulet-info-box">
            ...
            <div id="focusGemSelector" style="display:none; margin: 12px 0;">
                <label style="color:#a0aec0; font-size:0.75rem; display:block; margin-bottom:6px;">🎯 Gema Objetivo:</label>
    ...
    <div class="creative-menu-overlay" id="creativeMenuModal">
        <div class="creative-menu-box">
            ...
            <div class="creative-menu-title">🎨 Modo Creativo</div>
            <div class="creative-menu-subtitle">Modifica el juego a tu antojo</div>

            <!-- Plata -->
            <div class="creative-section collapsed">
                <div class="creative-section-title" onclick="this.parentElement.classList.toggle('collapsed')">🪙 Plata</div>
            ...
            <!-- Mejoras -->
            <div class="creative-section collapsed">
                <div class="creative-section-title" onclick="this.parentElement.classList.toggle('collapsed')">⬆️ Mejoras</div>
                <div class="creative-section-body">
                <div class="creative-row">
                ...
                <div class="creative-row">
                    <label>Nivel de Almacén (0-10)</label>
            ...
            <div class="creative-section collapsed">
                <div class="creative-section-title" onclick="this.parentElement.classList.toggle('collapsed')">💎 Items</div>
                <div class="creative-section-body">
                ...
                <div class="creative-row">
                    <select class="creative-select" id="creativeAmuletSelect">
                        <option value="amuleto_presion">Amuleto Presión</option>
                ...
                <div class="creative-row">
                    <button class="creative-btn gold" onclick="creativeGiveAll()" style="flex:1;">🎁 Dar todas las gemas, fusiones y amuletos</button>
                </div>
                </div>
            </div>
            ...
            <!-- Probabilidades -->
            <div class="creative-section collapsed">
                <div class="creative-section-title" onclick="this.parentElement.classList.toggle('collapsed')">🎲 Probabilidades de Aparición</div>
                <div class="creative-section-body">
    ...
    <div class="level-info-overlay" id="levelInfoModal">
        <div class="level-info-box">
            ...
            <div class="level-info-title">📊 Tu Nivel 📊</div>
            <div class="level-info-current" id="levelInfoCurrent">1</div>
            <div class="level-info-subtitle">Qué cosas te suben de nivel</div>
            <div class="li-stats-section collapsed" id="liStatsSection">
                <div class="li-stats-header" onclick="document.getElementById('liStatsSection').classList.toggle('collapsed')">
                    <span class="li-stats-title">📈 Stats</span>
    ...
    <div id="singularityCinematic">
        ...
        <div class="sc-buttons" id="scButtons">
            <button class="sc-btn-collect" id="scCollectBtn">📦 Recoger</button>
        </div>
    </div>
    ...
    <div id="godCrownCinematic">
        ...
        <div class="gc-title" id="gcTitle">👑 CORONA DE DIOS 👑</div>
